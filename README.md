...
TAPA is a dataflow HLS framework that is fast, expressive and generate high-freqeuncy FPGA accelerators.
...
- TAPA provides dedicated C++ APIs for arbitrary external memory access pattern.

- TAPA transparently merge small memory transactions into large bursts at runtime.
...
- TAPA provides **8×** faster RTL simulation than Vitis.[<sup>3</sup>](https://github.com/UCLA-VAST/tapa-fast-cosim)

- [in-progress] TAPA is integrating [RapidStream](https://github.com/Licheng-Guo/RapidStream) that is up to **10×** faster than Vivado.[<sup>4</sup>](https://vast.cs.ucla.edu/~chiyuze/pub/fpga22-rapidstream.pdf)
